    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <section className="bg-white dark:bg-gray-800 border-b dark:border-gray-700">
        <div className="max-w-7xl mx-auto px-4 py-8">
          ...
          <p className="text-gray-600 dark:text-gray-300">Jobs you've bookmarked for later application</p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4">
          {savedJobs.length === 0 ? (
            <div className="text-center py-16">
              ...
              <h2 className="text-xl font-semibold text-gray-700 dark:text-gray-300 mb-2">No saved jobs yet</h2>
              <p className="text-gray-500 dark:text-gray-400 mb-6">Start bookmarking jobs you're interested in</p>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {savedJobs.map((job) => (
                <div key={job._id} className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 relative">
                  <button
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-gray-500 dark:text-gray-400">{job.type || 'Full Time'}</span>
