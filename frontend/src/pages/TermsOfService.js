      ...
      <section className="py-12">
        <div className="max-w-4xl mx-auto px-4">
          <div className="prose max-w-none">
            ...
            <section className="mb-10">
              <h2 className="text-2xl font-bold mb-4 dark:text-white">2. Description of Service</h2>
              <p className="text-gray-600 dark:text-gray-300 mb-4">
            ...
            <section className="mb-10">
              <h2 className="text-2xl font-bold mb-4 dark:text-white">3. User Accounts</h2>
              <p className="text-gray-600 dark:text-gray-300 mb-4">
            ...
            <section className="mb-10">
              <h2 className="text-2xl font-bold mb-4 dark:text-white">4. Job Seeker Responsibilities</h2>
            ...
            <section className="mb-10">
              <h2 className="text-2xl font-bold mb-4 dark:text-white">5. Employer Responsibilities</h2>
              <ul className="list-disc pl-6 text-gray-600 dark:text-gray-300 space-y-2">
            ...
            <section className="mb-10">
              <h2 className="text-2xl font-bold mb-4 dark:text-white">6. Prohibited Activities</h2>
              <p className="text-gray-600 dark:text-gray-300 mb-4">Users may not:</p>
              <ul className="list-disc pl-6 text-gray-600 dark:text-gray-300 space-y-2">
            ...
            <section className="mb-10">
              <h2 className="text-2xl font-bold mb-4 dark:text-white">7. Privacy</h2>
              <p className="text-gray-600 dark:text-gray-300 mb-4">
            ...
            <section className="mb-10">
              <h2 className="text-2xl font-bold mb-4 dark:text-white">8. Payment and Billing</h2>
              <p className="text-gray-600 dark:text-gray-300 mb-4">
            ...
            <section className="mb-10">
              <h2 className="text-2xl font-bold mb-4 dark:text-white">9. Termination</h2>
              <p className="text-gray-600 dark:text-gray-300 mb-4">
            ...
            <section className="mb-10">
              <h2 className="text-2xl font-bold mb-4 dark:text-white">10. Changes to Terms</h2>
              <p className="text-gray-600 dark:text-gray-300 mb-4">
