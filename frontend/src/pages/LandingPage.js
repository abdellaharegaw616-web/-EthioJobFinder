...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Top Banner */}
      <div className="bg-gradient-to-r from-blue-800 via-purple-700 to-teal-600 text-white py-2 px-4 text-center relative">
        <p className="text-sm">
          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center gap-3">
              {user ? (
                <Link 
                  to="/dashboard" 
                  className="px-6 py-2 bg-gradient-to-r from-blue-500 to-purple-500 text-white rounded-full font-medium hover:shadow-lg transition"
                >
                  Dashboard
                </Link>
              ) : (
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-4">
                <Link 
                  ...
                  className="px-8 py-3 bg-gradient-to-r from-blue-500 via-purple-500 to-teal-600 text-white rounded-full font-medium hover:shadow-lg transition inline-block text-center"
                >
                  Find Talent
                </Link>
                <Link 
                ...
                <div className="space-y-3">
                  {jobs.slice(0, 3).map((job, i) => (
                    <div key={i} className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
                      <div className="w-10 h-10 bg-gradient-to-br from-blue-400 to-purple-400 rounded-lg flex items-center justify-center text-white font-bold">
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              {activeTab === 'companies' ? (
                <>
                  <div className="flex items-start gap-4">
                    <div className="w-12 h-12 bg-gradient-to-br from-blue-500 to-purple-500 rounded-xl flex items-center justify-center text-white font-bold text-lg flex-shrink-0">1</div>
                    <div>
                  ...
                  <div className="flex items-start gap-4">
                    <div className="w-12 h-12 bg-gradient-to-br from-blue-500 to-purple-500 rounded-xl flex items-center justify-center text-white font-bold text-lg flex-shrink-0">2</div>
                    <div>
            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-blue-400 via-purple-500 to-teal-600 rounded-2xl p-8 text-white">
      ...
      <section className="py-20 bg-gray-900 text-white relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 text-center relative z-10">
          ...
          <div className="w-32 h-32 mx-auto mb-8 relative">
            ...
            <div className="relative w-full h-full bg-gradient-to-br from-blue-400 via-purple-500 to-teal-500 rounded-full flex items-center justify-center">
