...
const OurStory = () => {
  ...
  const team = [
    { name: 'Helina Tadesse', role: 'Founder & CEO', image: 'bg-gradient-to-br from-green-400 to-yellow-500' },
    ...
    { name: 'Saron Girma', role: 'Head of Marketing', image: 'bg-gradient-to-br from-green-400 to-yellow-500' }
  ];
            ...
            <div className="bg-gradient-to-br from-green-100 to-yellow-100 rounded-3xl p-8">
              <div className="grid grid-cols-2 gap-6">
                <div className="text-center">
                  <p className="text-4xl font-bold text-green-500">100K+</p>
          ...
          <div className="space-y-8">
            {milestones.map((milestone, i) => (
              <div key={i} className="flex gap-6">
                ...
                <div className="flex-shrink-0 w-4 h-4 bg-gradient-to-r from-green-500 to-yellow-500 rounded-full mt-2" />
            ...
            {values.map((value, i) => {
              ...
              return (
                <div key={i} className="text-center p-6 rounded-2xl hover:bg-gray-50 transition">
                  <div className="w-16 h-16 bg-gradient-to-br from-green-100 to-yellow-100 rounded-2xl flex items-center justify-center mx-auto mb-4">
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <a 
              href="/jobs"
              className="px-8 py-3 bg-gradient-to-r from-green-500 to-yellow-500 text-white rounded-full font-medium hover:shadow-lg transition"
            >
              Find Work
            </a>
            <a 
