      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        {activeTab === 'verifications' && (
          <div className="bg-white rounded-lg shadow">
            <h2 className="text-xl font-semibold p-6 border-b">Pending Employer Verifications</h2>
        ...
        {activeTab === 'users' && (
          <div className="bg-white rounded-lg shadow">
            <h2 className="text-xl font-semibold p-6 border-b">All Users ({users.length})</h2>
            <div className="divide-y">
              {users.map(u => (
        ...
        {activeTab === 'jobs' && (
          <div className="bg-white rounded-lg shadow">
            <h2 className="text-xl font-semibold p-6 border-b">All Jobs ({jobs.length})</h2>
            <div className="divide-y">
              {jobs.map(job => (
